...
export const getApplicationsByStatus = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
...
export const getApplicationsBySeeker = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
